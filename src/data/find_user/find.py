...
from src.domain.use_cases import FindUser as FindUserInterface #pq é uma interface
from src.data.interfaces import UserRepositoryInterface as UserRepository
from src.domain.models import Users

class FindUser(FindUserInterface):
    """Class to define use case find"""
    def __init__(self, user_repository: Type[UserRepository]):
        self.user_repository = user_repository

    def by_id(self, user_id: int) -> Dict[bool, List[Users]]:
        """Muito grande pra escrever, preguiça"""
        response = None
    ...
    def by_name_and_id(self, user_id: int, name: str) -> Dict[bool, List[Users]]:
        """Baaah tche"""
        response = None
